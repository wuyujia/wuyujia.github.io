import{_ as i,W as d,X as e,a2 as n}from"./framework-aa83d01c.js";const a={},t=n(`<h2 id="存储过程的编写demo" tabindex="-1"><a class="header-anchor" href="#存储过程的编写demo" aria-hidden="true">#</a> 存储过程的编写Demo</h2><div class="hint-container info"><p class="hint-container-title">提示</p><pre><code>先参考怎么写，再了解过程和原理，先会用，解决燃煤之急
