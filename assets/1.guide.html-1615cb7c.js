...
<span class="token keyword">export</span> <span class="token keyword">const</span> zhSidebar <span class="token operator">=</span> <span class="token function">sidebar</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
  ...
  <span class="token punctuation">]</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="可选图标内容" tabindex="-1"><a class="header-anchor" href="#可选图标内容" aria-hidden="true">#</a> 可选图标内容</h2>`,9),x={href:"https://theme-hope.vuejs.press/zh/guide/interface/icon.html#%E6%B5%8F%E8%A7%88%E5%9B%BE%E6%A0%87",target:"_blank",rel:"noopener noreferrer"},q=t(`<h2 id="部署发版到github配置" tabindex="-1"><a class="header-anchor" href="#部署发版到github配置" aria-hidden="true">#</a> 部署发版到Github配置</h2><div class="hint-container info"><p class="hint-container-title">相关信息</p><p>这个很关键，如果这一步配置好了，只需要写文章，发布到github，甚至可以直接在github页面编辑源代码就可以完成发布<br> 很高级</p></div><p>在 <a href="#%E5%AE%89%E8%A3%85VuePress">安装VuePress这一步</a> 中如果选择了gitflow那就很方便了。如果没有选择，那就重新安装一遍吧。</p><p>在<code>.github/workflows/deploy-docs.yml</code>中可以配置发版项目相关信息，需要改动的点有如下几处</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">on</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="关于gitpages配置" tabindex="-1"><a class="header-anchor" href="#关于gitpages配置" aria-hidden="true">#</a> 关于GitPages配置</h2>`,9);function w(E,B){const e=p("ExternalLinkIcon"),i=p("RouterLink");return c(),l("div",null,[d,v,k,n("p",null,[n("a",m,[s("环境安装教程"),a(e)])]),h,b,n("p",null,[n("a",g,[s("安装教程"),a(e)])]),f,n("p",null,[n("a",y,[s("安装教程"),a(e)])]),_,n("ul",null,[n("li",null,[n("a",x,[s("图标地址"),a(e)])])]),q,n("ul",null,[n("li",null,[a(i,{to:"/guide/vuepress/2.gitpages-setting.html"},{default:u(()=>[s("关于GitPages配置")]),_:1})])])])}const z=o(r,[["render",w],["__file","1.guide.html.vue"]]);export{z as default};
