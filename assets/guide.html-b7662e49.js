...
<span class="token keyword">export</span> <span class="token keyword">const</span> zhSidebar <span class="token operator">=</span> <span class="token function">sidebar</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
  ...
  <span class="token punctuation">]</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="部署发版到github配置" tabindex="-1"><a class="header-anchor" href="#部署发版到github配置" aria-hidden="true">#</a> 部署发版到Github配置</h2><div class="hint-container info"><p class="hint-container-title">相关信息</p><p>这个很关键，如果这一步配置好了，只需要写文章，发布到github，甚至可以直接在github页面编辑源代码就可以完成发布<br> 很高级</p></div>`,10),q=i(`<p>在<code>.github/workflows/deploy-docs.yml</code>中可以配置发版项目相关信息，需要改动的点有如下几处</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">on</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="关于gitpages配置" tabindex="-1"><a class="header-anchor" href="#关于gitpages配置" aria-hidden="true">#</a> 关于GitPages配置</h2>`,6);function x(w,E){const e=o("ExternalLinkIcon"),t=o("RouterLink");return l(),u("div",null,[d,v,k,n("p",null,[n("a",m,[s("环境安装教程"),a(e)])]),h,b,n("p",null,[n("a",g,[s("安装教程"),a(e)])]),y,n("p",null,[n("a",f,[s("安装教程"),a(e)])]),_,n("p",null,[s("在"),a(t,{to:"/guide/vuepress/guide.html#%E5%AE%89%E8%A3%85vuepress"},{default:p(()=>[s("这一步")]),_:1}),s("中如果选择了gitflow那就很方便了。如果没有选择，那就重新安装一遍吧。")]),q,n("ul",null,[n("li",null,[n("p",null,[a(t,{to:"/guide/vuepress/gitpages-setting.html"},{default:p(()=>[s("关于GitPages配置")]),_:1})])]),n("li",null,[n("p",null,[a(t,{to:"/demo/markdown.html"},{default:p(()=>[s("Markdown 展示")]),_:1})])])])])}const z=c(r,[["render",x],["__file","guide.html.vue"]]);export{z as default};
