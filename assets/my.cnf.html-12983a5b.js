import{_ as n,W as e,X as i,a1 as s}from"./framework-817d905c.js";const l={},a=s(`<h2 id="慢sql语句检测时间" tabindex="-1"><a class="header-anchor" href="#慢sql语句检测时间" aria-hidden="true">#</a> 慢SQL语句检测时间</h2><p>查询</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>mysql<span class="token operator">&gt;</span> show variables like <span class="token string">&#39;long_query_time&#39;</span><span class="token punctuation">;</span>
+-----------------+-----------+
